...
{
  title: '두 세계를 잇는 실시간 AI 번역 플랫폼',
  subtitle: 'Papago STT 기술을 활용한 실시간 번역 및 비즈니스·문화 맞춤형 화상회의 서비스',
  tags: ['FE', '웹', '디자인', '팀'],
  image: '/project-images/project_tal1.png', // TODO: 메인 썸네일 캡처로 교체
  type: 'talaria',
  details: {
    modalTitle: '두 세계를 잇는 실시간 AI 번역 플랫폼',
    subtitle: 'Papago STT 기술을 활용한 실시간 번역 및 비즈니스·문화 맞춤형 화상회의 서비스',
    ...
    overview:
      'Talaria는 비즈니스 회의와 K-컬쳐/밈 라이브를 모두 지원하는 실시간 AI 번역 플랫폼으로, 회의 음성을 STT·번역해 자막으로 보여주고 매너 체크, 문서·회의록 연동까지 제공하는 서비스입니다. 저는 이 프로젝트에서 랜딩·대시보드·영상 회의·문화 라이브·문서/회의록 뷰어·파일 업로드 등 핵심 화면의 React 프론트엔드와 반응형 UI/UX 설계를 담당했습니다.',
