...
const About = () => {
  return (
    ...
    >
      ...
      <div
        className="w-full max-w-6xl bg-[#f8f9fa] rounded-3xl shadow-2xl 
      ...
      >
        ...
        <div className="flex flex-col items-center basis-1/3 text-center">
          ...
          />
          <div className="font-extrabold text-2xl text-gray-800 mt-4">
            이진근
          </div>
          <div className="text-gray-600 text-base mt-1">🎂 1994.01.11</div>
          <div className="flex flex-wrap gap-2 justify-center mt-4">
            <span className="bg-blue-100 text-blue-800 rounded-full px-4 py-1 text-sm font-medium">
              #사용자중심
            </span>
            <span className="bg-green-100 text-green-800 rounded-full px-4 py-1 text-sm font-medium">
              #책임감
            </span>
            <span className="bg-purple-100 text-purple-800 rounded-full px-4 py-1 text-sm font-medium">
              #협업
            </span>
            <span className="bg-yellow-100 text-yellow-800 rounded-full px-4 py-1 text-sm font-medium">
              #지속성장
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-10 basis-3/3">
          ...
          <div className="text-gray-700 text-lg leading-relaxed text-center md:text-left">
            끊임없이 배우며 성장하는 프론트엔드 개발자 이진근입니다. 웹 기술에
            대한 꾸준한 관심과 함께,{" "}
            <span className="font-bold">사용자 중심의 UI 구현</span>에 강점을
            가지고 있습니다.
            <br />
            <br />
            HTML, CSS는 물론 JavaScript와 React 기반 프론트엔드 개발에 익숙하며,
            자기주도적 학습과{" "}
            <span className="font-bold">팀원 간의 원활한 협업 경험</span>을
            쌓아왔습니다.
            <br />
            <br />
            인공지능사관학교에서 알고리즘, 컴퓨터 비전, 다양한 프레임워크를
            체계적으로 익혔고, 다양한 실무 프로젝트를 통해 기술과{" "}
            <span className="font-bold">소통력</span>을 동시에 길렀습니다.
            <br />
            <br />
            앞으로도 이해하기 쉬운 코드와 명확한 시스템을 만드는 개발자가
            되겠습니다.
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <ul className="text-base text-gray-700 space-y-3">
                ...
                <li>
                  <span className="font-semibold">조선대학교 전기공학과</span>
                  <br />
                  <span className="text-gray-500 text-sm">
                    2012.02 ~ 2018.02
                  </span>
